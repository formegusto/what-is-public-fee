...
class PublicPredictor:
    def __init__(self,
        ...
        self.APT = APT
        self.households_kWh = month_df['usage (kWh)'].sum()
    ...
    def setting_rest(self):
        ...
        self.guarantee = sum([_.guarantee for _ in self.calc.households])
    ...
    def predict(self):
        ...
        elec_bill = self.basic + self.elec_rate + self.env - self.fuel + self.guarantee
